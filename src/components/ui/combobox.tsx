...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      className={cn(
        "border-input focus-within:border-ring focus-within:ring-ring/50 focus-within:ring-1 has-aria-invalid:border-destructive has-aria-invalid:ring-destructive/20 has-aria-invalid:ring-1 dark:bg-input/30 dark:has-aria-invalid:border-destructive/50 dark:has-aria-invalid:ring-destructive/40 flex min-h-8 flex-wrap items-center gap-1 rounded-lg border bg-transparent bg-clip-padding px-2.5 py-1 text-sm transition-colors has-data-[slot=combobox-chip]:px-1",
        className
      )}
